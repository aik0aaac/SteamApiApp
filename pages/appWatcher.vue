...
import InitialRegisteredAppId from '~/components/data/appId/InitialRegisteredAppId.vue'
import CurrentAppIdList from '~/components/data/appId/CurrentAppIdList.vue'
import EditAppIdList from '~/components/data/appId/editAppIdList/index.vue'
